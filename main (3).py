...
2. Sends confirmation email via Gmail API (OAuth not needed — uses app password via SMTP submission port 587)
"""
import base64
import json
import os
...
<div style="font-family:Arial,sans-serif;max-width:560px;margin:0 auto;color:#1a1710;">
  ...
  <div style="background:#fff;padding:32px;border:1px solid #e8e4dc;border-top:none;border-radius:0 0 8px 8px;">
    ...
    # Use port 587 (STARTTLS) instead of 465 — more permissive on cloud hosts
